# 🚀 INVOICE AUTOMATION v1.4 - DEPLOYMENT GUIDE
...
### 🎯 **SEARCH LOCATION: EMAIL SUBJECT ONLY**
...
4. Watch the execution log (View → Execution log)
...
**Spanish:**
- factura, fra, fac, recibo, nómina, pago
...
**French:**
- facture, reçu, paiement, quittance
...
## 🎯 SELLING POINTS (FOR PRODUCT VERSION)

### Universal Language Support
✅ Works with Gmail in **any language**
✅ No code changes needed for different countries
✅ Simply customize keywords for client's region

### Fast & Efficient
✅ Filters at Gmail API level (not after downloading)
✅ Only processes relevant emails
✅ Saves bandwidth and execution time

### Easy Customization
✅ All settings in one CONFIG object
✅ Clear documentation for each setting
✅ Examples provided for major languages

### Client-Ready Features
✅ Automatic duplicate prevention
✅ Organized year/quarter folder structure
✅ Automated data extraction with Vision API
✅ Scheduled twice-daily runs
✅ Email notifications on completion

---

**v1.4 is ready to deploy!** 🚀
